    ...
    services: [
      {
        ...
        items:   ['Biotopes', 'Swimming Ponds', 'Living Pools', 'Garden Ponds', 'Water in the Garden', 'Fountains and Water Features'],
        extras:  [],
        btn:     'See more',
        href:    '/swimming-ponds',
      },
  ...
  fr: {
    ...
    services: [
      ...
      },
      {
        ...
        color:   'olive',
        title:   'Jardins',
        items:   ['Systèmes de Pelouse', 'Plantation', 'Travaux de pierre', "Systèmes d'Irrigation", 'Maçonnerie', 'Clôtures'],
  ...
  de: {
    ...
    services: [
      ...
      },
      {
        ...
        color:   'lime',
        title:   'Dachbegrünung',
        items:   ['Extensivbegrünung', 'Intensivbegrünung', 'Fassadenbegrünung', 'Dachbegrünung vom Carport', 'bis zu Industriehallen'],

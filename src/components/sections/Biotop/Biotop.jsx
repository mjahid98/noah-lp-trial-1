...
const t = {
  en: {
    ...
    body:            "Natural pools from my Garden are so aesthetically pleasing and idyllic: naturally, they're all built with the expertise of our partner Biotop!",
  ...
  fr: {
    ...
    body:            "Les piscines naturelles de my Garden sont si esthétiques et idylliques : elles sont naturellement construites avec l'expertise de notre partenaire Biotop !",
    cta_text:        'Visitez notre partenaire agréé et inspirez-vous...',
    btn:             'Contactez-nous',
  ...
  de: {
    ...
    body:            'Naturpools von my Garden sind so ästhetisch ansprechend und idyllisch: Natürlich werden sie alle mit der Expertise unseres Partners Biotop gebaut!',
